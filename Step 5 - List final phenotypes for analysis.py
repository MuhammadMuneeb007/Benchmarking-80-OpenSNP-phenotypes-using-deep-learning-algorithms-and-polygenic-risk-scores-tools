...
for loop in allfiles:
 if ".OMNI." not in loop and ".R" not in loop and ".pdf" not in loop and ".sh" not in loop and "PRSice" not in loop and "plink" not in loop and "gtool" not in loop and "snptest" not in loop and ".err" not in loop and ".out" not in loop and ".txt" not in loop and "23andme" not in loop and ".csv" not in loop and ".py" not in loop and ".html" not in loop and "opensnp_datadump.current" not in loop:
  if os.path.isdir(loop) and "final.QC.bed" in os.listdir(loop+"/")  :
   #print("\n")
...
import pdfkit
pdfkit.from_file('Analysis3.html', 'Analysis3.pdf')
