   ...
   for c1 in clump1:
    for c2 in clump2:
     for c3 in clump3:
      ...
      rs2['PlinkMCC'] = plinkMCC


      rs.to_csv(direc+os.sep+"Results_Plink_AUC.txt",index=False)
      rs2.to_csv(direc+os.sep+"Results_Plink_MCC.txt",index=False)
      print(rs)
      print(rs2)
